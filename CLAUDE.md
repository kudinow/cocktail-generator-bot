...
**Обновление:** 2026-02-21 — База расширена до 1144 рецептов; сайт пересобран (1815 страниц)
...
- ✅ **Добавлено:** Локальная база из 1144 рецептов Inshaker ([data/inshaker_recipes.json](data/inshaker_recipes.json))
...
- 📊 **База данных:** 1144 рецептов (1144 алкогольных, 0 безалкогольных)
- 🌐 **Сайт:** https://alcoberry.ru (1815 страниц, Яндекс Object Storage, HTTPS)
...
- **Данные** (`data/`):
  ...
  - `inshaker_recipes.json` — база из 1144 рецептов коктейлей (Inshaker)
