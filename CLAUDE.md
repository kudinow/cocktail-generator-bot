...
**Обновление:** 2026-02-20 — Добавлена система управления парсингом через таблицы
...
- ✅ **Добавлено:** Локальная база из 93 рецептов Inshaker ([data/inshaker_recipes.json](data/inshaker_recipes.json))
...
- 📊 **База данных:** 93 рецепта (93 алкогольных, 0 безалкогольных)
...
- **Данные** (`data/`):
  ...
  - `inshaker_recipes.json` — база из 93 рецептов коктейлей (Inshaker)
